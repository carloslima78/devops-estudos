...
- Opcionalmente, baixe a imagem publicada no Docker Hub:

```hcl
docker pull carloslimadocker78/demospringbootimage:latest
```

- Execute o container diretamente basedo na imagem publicada no Docker Hub:
